...
/**
 * Represents a sequence of moves that a player has performed, like in a recording, for a particular level. This is
 * utilized whenever the player has successfully completed a level and wishes to playback the result.
 * @author Henry Wang
 */
public class Recording implements Serializable {
    ...
    private static class CompactMove {
        ...
        private void read(DataInput in) throws IOException {
            ...
            switch (mode) {
                case SIZE_BYTE:
                    repetition = in.readByte();
                    break;
                case SIZE_SHORT:
                    repetition = in.readShort();
                    break;
                case SIZE_INT:
                    repetition = in.readInt();
                    break;
                case SIZE_LONG:
                    repetition = in.readLong();
                    break;
                default:
                    throw new IOException("Illegal data size mode");
            }
            if (repetition < 0) {
        ...
        private void write(DataOutput out) throws IOException {
            ...
            switch (mode) {
                case SIZE_BYTE:
                    out.writeByte((byte) repetition);
                    break;
                case SIZE_SHORT:
                    out.writeShort((short) repetition);
                    break;
                case SIZE_INT:
                    out.writeInt((int) repetition);
                    break;
                case SIZE_LONG:
                    out.writeLong(repetition);
                    break;
                default:
                    throw new InternalError("Illegal size mode");
            }
